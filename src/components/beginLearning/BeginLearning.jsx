    ...
    <div className='mmain'>
      <div className="container">
        <div className="contents-1">
          <h1 className='contents-1-h1'>Personalized learning that gets results</h1>
        ...
        <div className="contents-2">
          <div className="sub-content s-1">
            ...
            <h3 className='sub-content-1-h3'>Connect and collaborate with like-minded individuals, fostering a sense of belonging and enriching your learning experience.</h3>
          </div>
          ...
          <div className="sub-content s-4">
            ...
            <h3 className='sub-content-4-h3'>Access a well-organized LMS with all the resources you need, including clear course structures, recordings, and learning trackers.</h3>
          </div>
        </div>
      </div>

      <div className="button">
        <Link className='button-light one' to={'./signup'}>
